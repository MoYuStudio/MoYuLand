...
| N/A | 功能 | ColorMOTD | 自定义服务器的MOTD（欢迎信息）颜色 |
| N/A | 功能 | Craftmatic | 提供自定义合成配方的功能 |
| N/A | 功能 | DualWield-3.0 | 允许玩家在副手持有物品 |
| N/A | 功能 | Dynmap-3.6-beta-1-spigot | 在网页上展示服务器地图的功能 |
| N/A | 功能 | EasyCarts-3.0.0 | 添加简易的列车系统到服务器 |
| N/A | 功能 | FakePlayer-3.0.4 | 添加虚拟玩家到服务器 |
| N/A | 功能 | FasterPathways | 提供更快的路径生成算法 |
| N/A | 功能 | ImageFrame-1.7.4.0 | 在画框中显示图像的功能 |
| N/A | 功能 | IronElevator-1.6.2 | 提供铁质电梯的功能 |
| N/A | 功能 | KeepChunks-1.6.10 | 保持指定区块始终加载的功能 |
...
| N/A | 功能 | SimpleSit | 允许玩家坐下的功能 |
| N/A | 功能 | SkinsRestorer | 允许玩家使用自定义皮肤的功能 |
| N/A | 功能 | Vault | 提供经济和权限管理功能 |
| N/A | 功能 | WebStats-1.8.6+mc1.18+ | 提供网页统计信息的功能 |
| N/A | 功能 | hsrails | 提供高速铁路系统的功能 |
| N/A | 功能 | toolstats-1.6.2 | 提供工具使用统计的功能 |
| N/A | 反作弊 | AntiXRay-1.9.0 | 防止玩家使用X射线透视作弊的插件 |
| N/A | 回溯 | CoreProtect-21.3 | 提供方块和玩家操作的回溯功能 |
| N/A | 备份 | ServerBackup | 提供服务器备份功能 |
| N/A | 椅子 | RifleChairs | 添加使用步枪的椅子功能 |
| N/A | 管理 | PlugManX | 提供插件管理功能 |
| N/A | 跨版本 | ViaBackwards-4.7.0 | 在不同版本之间进行兼容转换的功能 |
| N/A | 跨版本 | ViaRewind-2.0.3 | 在不同版本之间进行兼容转换的功能 |
| N/A | 跨版本 | ViaVersion-4.7.0 | 在不同版本之间进行兼容转换的功能 |
